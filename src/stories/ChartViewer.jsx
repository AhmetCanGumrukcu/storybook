...
import TChart from '../../components/ui/charts/t-chart'
    ...
    <div className="col-xl-6">
      <div className="box box-default">
        ...
        <div className="box-body">
          <TChart option={bar1.options} showLoading={false} />
        </div>
      </div>
    </div>
    <div className="col-xl-6">
      <div className="box box-default">
        ...
        <div className="box-body">
          <TChart option={bar2.options} showLoading={false} />
        </div>
      </div>
    </div>
  </div>
  ...
  <div className="row">
    <div className="col-xl-6">
      <div className="box box-default">
        ...
        <div className="box-body">
          <TChart option={bar3.options} showLoading={false} />
        </div>
      </div>
    </div>
    <div className="col-xl-6">
      <div className="box box-default">
        ...
        <div className="box-body">
          <TChart option={bar4.options} showLoading={false} />
        </div>
      </div>
    </div>
  </div>
  ...
  <div className="row">
    <div className="col-xl-12">
      <div className="box box-default">
        ...
        <div className="box-body">
          <TChart option={bar5.options} showLoading={false} />
        </div>
      </div>
    </div>
  </div>
